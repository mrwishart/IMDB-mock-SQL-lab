# Recreating IMDB with SQL and Inner Joins

Week 3, Day 4 Paired Programming Lab at CodeClan with Catriona. Designed to reinforce the use of inner joins in SQL. Original brief below:
